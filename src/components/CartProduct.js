...
return (<>
    ...
    <div className='relative w-full mx-1 flex rounded-2xl p-2 text-[#fad636da] transition-all duration-150'>
        <img
        ...
        <Link to={"/shop/"+_id}>
            <h1 className='text-xl font-bold h-1/5 overflow-hidden'>{name}</h1>
            <h1 className='w-full h-1/2 overflow-hidden'>{description}</h1>
